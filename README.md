...
The repository now includes the Step 6 dashboard, reminders, and reporting foundation:
...
- Owner-facing reports with filters, print-friendly views, and CSV exports
...
Charts, saved report preferences, PDF generation, advanced document processing, and Stripe billing are intentionally deferred beyond this reminder and reporting step.
...
Reports are available at `/reports`. CSV exports are generated server-side from the current owner company and filters, include company/generated metadata, escape spreadsheet-dangerous values, and omit internal IDs.
